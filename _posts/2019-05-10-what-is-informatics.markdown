...
specialized skill, something you learn to follow a certain kind of career.
...
But as pragmatic as this pragmatic might look, it's very short-sighted:
...
> One of the possibile representation of an information that can be
> transferred and interpreted as informations by humans.

Information only exists in a human mind.

Not every construct of a human mind is an information, but only
...
However Information is the fundamental building block of human knowledge.
...
Data instead are representations.

Any representation of a Information is actually a datum.

The words you are reading, be them printed or drawn on a raster screen,
just represent a message I'm trying to convey, an insight built over years
...
For example the informations about this text itself, its language, its
length and so on, are what is often improperly called "metadata".
But even some personal informations about me are embedded in these data,
as the style of my writings might reveal.

If instead of a text the information was carried through a video
...
mathematical function could describe this relation: there is both loss of
information and addition of it at every passage.
...
and we care about the words we use because we know, after thousand years of
history, that they forge our understanding of reality.

Indeed in a well known essay, Knuth defines Computer Science as 
"[the study of Algorithms](http://www.maa.org/programs/maa-awards/writing-awards/computer-science-and-its-relation-to-mathematics)"
...
Algorithms are Informations in the mind of people knowing them.
...
As data, programs can be wrong even when they try to represent a
correct algorithm just because humans are inheritely fallible.

Each program is just one of the many possible representation of an
...
programmers developed a [wide set](https://www.adacore.com/sparkpro/) [of tools](https://www.learntla.com/introduction/)
...
way that is way deeper than what you feel when learning another human language.
...
And yet, the real key to understand the Political Power of Informatics is
debugging. Through debugging you look for an error in the collective
cultural elaboration of hundred thousand people from all over the world.

You see a computer executing a trillions of lines of code and you have to
...
and you **have** to find (and kill) the butterfly hundreds of miles away
to stop the tornado you are in. 

Compared to this, **debunking a Fake News is a kid game**.

Compared to this, debunking a Lobbist is a kid game!
